...
accelerate launch --config_file configs/deepspeed_zero3.yaml \
    ...
    --output_dir /root/group-shared/jrc/ppo-test/models/deepspeed_test_larger_batch \
    --learning_rate 3e-6 \
    ...
    2>&1 | tee -a /root/group-shared/jrc/ppo-test/logs/deepspeed_test_larger_batch.log